...
arora.config(['$routeProvider',
  function ($routeProvider) {
	  ...
	  $routeProvider.when('/message/add', { templateUrl: path + 'messageForm.html', controller: 'MessageEditController' });
	  $routeProvider.when('/message/edit/:messageID', { templateUrl: path + 'messageForm.html', controller: 'MessageEditController' });
	  ...
	  $routeProvider.when('/comment/add/:messageID', { templateUrl: path + 'commentForm.html', controller: 'CommentEditController' });
	  $routeProvider.when('/comment/edit/:commentID', { templateUrl: path + 'commentForm.html', controller: 'CommentEditController' });
