...
angular.module('guestbook.Services', [])
	.service('rest', ['$http', '$rootScope', function ($http, $rootScope) {
	    ...
	    this.saveMessage = function (message, cb) {
			return this.post("/api/message", {}, message, cb);
	    };
	    this.deleteMessage = function (id, cb) {
			this.delete("/api/message", {id:id,}, cb);
	    };
	    this.voteMessage = function (messageID, rating, cb) {
			this.post("/api/rating", {}, {MessageID:messageID,Value:rating}, cb);
	    };
	    ...
	    this.deleteComment = function (id, cb) {
			this.delete("/api/comment", {id:id,}, cb);
	    };
